...
<body>
		...
		<nav class="grey darken-2">
			<div class="nav-wrapper z-depth-4">
				...
				<ul id="menu" class="dropdown-content">
					<li><a href="#!" class="center"><i class="right material-icons">help</i>Help</a></li>
				</ul>
			</nav>
		</nav>
	</div>
	...
	<div class="fixed-action-btn">
		<a href="#" class="btn-floating btn-large waves-effect waves-teal grey darken-2 z-depth-3">
			<i class="material-icons">arrow_upward</i>
		</a>
		<ul>
			<li><a href="add" class="btn-floating waves-effect waves-teal red darken-2 z-depth-4"><i class="material-icons" title="Create New Ticket">add</i></a></li>
